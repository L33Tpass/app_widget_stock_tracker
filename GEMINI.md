...
- **Terminologie Widget** : Lorsque le terme "widget" est mentionné, il fait systématiquement référence au widget natif pour l'écran d'accueil Android (Android AppWidget / Home Screen Widget) et non à un simple widget d'interface Flutter interne. Toute modification demandée sur le widget doit être implémentée côté natif Android en priorité (fichiers XML de layout, Java/Kotlin du Provider, AndroidManifest).
